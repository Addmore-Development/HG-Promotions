...
// REPLACE each service function body with a real fetch() when the API is ready.
// Demo login:  mobile 0831234567  →  approved promoter (Lebo, p-003)
//              mobile 0831111111  →  new promoter (p-new)
//              OTP always: 123456
// ─────────────────────────────────────────────────────────────────────────────
...
export const MOCK_SHIFTS: Shift[] = [
  ...
  {
    // Upcoming shift — used for geo check-in demo
